...
<div class="container" style="margin-top: 10px;">
	<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tr>
							...
							<td > 
								<button type="button" class="btn btn-info" onclick="document.location = 'MHVSView.php?id=<?php echo $patient['PatientID']?>';">VIEW RECORD</button>
								<button type="button" class="btn btn-info" onclick="document.location = 'MHVSADD.php?id=<?php echo $patient['PatientID']?>';">ADD RECORD</button>
							</td>
